...
\begin{figure}
    \centering
    \subfigure{\includegraphics[width=0.49\textwidth]{plots/complex_p2.pdf}}
    \subfigure{\includegraphics[width=0.49\textwidth]{plots/real_p2.pdf}}
    \vfill
    \subfigure{\includegraphics[width=0.49\textwidth]{plots/complex_p10.pdf}}
    \subfigure{\includegraphics[width=0.49\textwidth]{plots/real_p10.pdf}}
    \vfill
    \subfigure{\includegraphics[width=0.49\textwidth]{plots/complex_primes.pdf}}
    \subfigure{\includegraphics[width=0.49\textwidth]{plots/real_primes.pdf}}
